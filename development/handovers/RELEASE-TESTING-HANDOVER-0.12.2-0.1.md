# BC-250 0.12.2-0.1 release testing handover

## Scope

Build and test the exact `bc250-llm-server-0.12.2-0.1` candidate. This is a new functional/runtime
...
-> full /var/lib/open-webui rollback archive is produced

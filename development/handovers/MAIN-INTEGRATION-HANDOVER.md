...
`0.12.2-0.3` is the next functional/device candidate. Exact-installed 0.12.1-0.6 established a clean
...
Current 0.12.2-0.3 evidence boundary:

```text
release metadata                 0.12.2-0.3
...
0.12.2 final source gate        PASS — static preflight + syntax checks + focused affected tests; 484-method full inventory not rerun by integration instruction
GitHub RPM/SRPM build gate         pending
exact-0.12.2-0.3 device gate      pending
```
...
## P0 — build and exact-0.12.2-0.3 crossed-boundary qualification
...
11. build RPM/SRPM in the authoritative Fedora path, then run development/handovers/RELEASE-TESTING-HANDOVER-0.12.2-0.3.md.
```
...
- 0.12.2-0.3 needs the authoritative Fedora RPM/SRPM build plus the crossed-boundary device gate in `RELEASE-TESTING-HANDOVER-0.12.2-0.3.md`; exact 0.12.1-0.6 remains comparison evidence, not qualification of the new runtime/model candidate;
...
> `0.12.2-0.3`; exact installed `0.12.1-0.6` is the immediate clean device/runtime comparison baseline,
...
> `development/handovers/RELEASE-TESTING-HANDOVER-0.12.2-0.3.md`. GitHub/Fedora owns RPM/SRPM builds,

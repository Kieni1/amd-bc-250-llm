...
Current contract for the active source tree. The explicit lifecycle semantics originate from the 0.11.3 model-manager redesign and are carried forward unless a documented defect requires change.

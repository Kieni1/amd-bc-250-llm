...
The 0.10.0-1.1 catalog deliberately retains the operator's broader comparison
...
size coverage without changing production defaults. The 0.10.0-1.1 pool also
